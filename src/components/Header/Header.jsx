    ...
    return (
        <div className={styles.header}>
            <div className={styles.filter_item}>
                ...
                <input type="text" id="label-filed" value={inputsValue.field} name="field" onChange={(e) => { dispatch(addInputsValue({ ...inputsValue, [e.target.name]: e.target.value })); addQuery(e.target.name, e.target.value) }} />
            </div>

            <div className={styles.filter_item}>
                <label htmlFor="label-ads">نام آگهی</label>
                <input type="text" id="label-ads" value={inputsValue.ads} name="ads" onChange={(e) => { dispatch(addInputsValue({ ...inputsValue, [e.target.name]: e.target.value })); addQuery(e.target.name, e.target.value) }} />
            </div>

            <div className={styles.filter_item}>
                <label htmlFor="label-date">تاریخ</label>
                <input type="text" value={inputsValue.date} name="date" id="label-date" onChange={(e) => { dispatch(addInputsValue({ ...inputsValue, [e.target.name]: e.target.value })); addQuery(e.target.name, e.target.value) }} />
            </div>

            <div className={styles.filter_item}>
                <label htmlFor="label-change">نام تغییر دهنده</label>
                <input type="text" value={inputsValue.nameChanger} name="nameChanger" id="label-change" onChange={(e) => {
